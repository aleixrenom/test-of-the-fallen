...
module.exports = {
	...
	async rollWeather() {
		...
		await cf.client.channels.cache.get(data.weatherChannel).send(todayWeatherEmbed);
		...
		await cf.client.channels.cache.get(data.forecastChannel).send(tomorrowWeatherEmbed);
